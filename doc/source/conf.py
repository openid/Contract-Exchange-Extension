# -*- coding: utf-8 -*-
#
# OpenID CX documentation build configuration file, created by
...
latex_documents = [
  ('index', 'OpenIDCX.tex', u'OpenID CX Documentation',
   u'hdknr.com', 'manual'),
]
...
man_pages = [
    ('index', 'openidcx', u'OpenID CX Documentation',
     [u'hdknr.com'], 1)
]
